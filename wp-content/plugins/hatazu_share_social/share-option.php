...
function htz_share_menu_menu() {
    add_menu_page('menu share Settings', 'option share', 'administrator', 'share-menu-settings', 'share_menu_settings_page', 'dashicons-admin-generic');
}
...
function share_social_box( ) {    
    //if( is_single() || is_page() ) {
      // Get current page URL 
          ...
          $scriptsocial .='<div class="dzalo"><ul class="share-links__list"><li class="fb-like" data-href="'.$link.'" data-layout="button_count" data-action="like" data-size="small" data-show-faces="false" data-share="true"></li>';
          $scriptsocial .='<li class="zalo-share-button" data-href="'.$link.'" data-oaid="579745863508352884" data-layout="1" data-color="blue" data-customize=false></li></div>';
          echo $scriptsocial;
      //}
  }
//add_filter( 'the_content', 'share_social_box', 20 );
function script_dev(){ 
    if(is_single() || is_page() && !is_page_template(array('page-template.php'))) { ?>
        <div id="fb-root"></div>
