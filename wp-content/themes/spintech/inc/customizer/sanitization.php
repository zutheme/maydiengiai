 ...
 */
function spintech_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function spintech_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function spintech_sanitize_html( $html ) {
 ...
 */
function spintech_sanitize_image( $image, $setting ) {
 ...
 */
function spintech_sanitize_nohtml( $nohtml ) {
 ...
 */
function spintech_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function spintech_sanitize_range_value( $number, $setting ) {
 ...
 */
function spintech_sanitize_select( $input, $setting ) {
 ...
 */
function spintech_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function spintech_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function spintech_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
