...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="cart__table cart-table" cellspacing="0">
					...
					<tr class="cart-table__row">
						...
						if ( ! $product_permalink ) {
							...
							<div class="product-image">
								<a href="<?php echo esc_url( $product_permalink ); ?>" class="product-image__body"><?php echo $thumbnail; ?></a>
                     		</div> 
						<?php //printf( '<div class="product-image"><a href="%s">%s</a></div>', esc_url( $product_permalink ), $thumbnail ); // PHPCS: XSS ok.
						}
						?>
						</td>
