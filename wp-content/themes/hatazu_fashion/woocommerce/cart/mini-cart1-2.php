				...
				<div class="dropcart__product">
					...
					<div class="dropcart__product-info">
						...
						<?php
							...
							// 	echo '<li>'.wc_attribute_label( $attribute ).': '.$term->name.'</li>';
						...
						echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
							...
							sprintf(
								'<a href="%s" class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s">&times;</a>',
