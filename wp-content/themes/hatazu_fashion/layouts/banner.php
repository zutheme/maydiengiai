...
<?php $banner = get_field('barner_promotion_img','customizer'); 
    $barner_mobile = get_field('barner_promotion_img_mobile','customizer'); 
?>
<div class="block block-banner">
    <div class="container">
        <a href="<?php echo get_field('barner_promotion_link','customizer'); ?>" class="block-banner__body">
            ...
            <div class="block-banner__image block-banner__image--mobile" style="background-image: url('<?php echo $barner_mobile['url']; ?>')"></div>
