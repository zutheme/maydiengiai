	...
	<div class="site-header">
		...
		<div class="site-header__middle container">
			<div class="site-header__logo">
				<a href="<?php bloginfo('url'); ?>"><img class="logo" src="<?php echo $logo['url']; ?>"></a>
			</div>
			...
			<div class="site-header__phone">
				<?php $phone1 = get_field('header_phone1','customizer'); ?>
				<div class="site-header__phone-title"><?php echo get_field('header_phone1_text','customizer'); ?></div>
				<div class="site-header__phone-number"><a href="tel:<?php echo preg_replace('/[^0-9]/', '', $phone1); ?>"><?php echo $phone1; ?></a></div>
			</div>
		</div>
