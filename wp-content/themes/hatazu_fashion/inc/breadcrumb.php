...
function custom_breadcrumbs() {
    ...
    if ( !is_front_page() ) {
        ...
        // Home page
        echo '<li class="breadcrumb-item"><a  href="' . get_home_url() . '">' . $home_title . '</a>&nbsp;<svg class="breadcrumb-arrow" width="6px" height="9px"><use xlink:href="'.get_template_directory_uri().'/images/sprite.svg#arrow-rounded-right-6x9"></use></svg></li>';
        //echo '<li class="separator separator-home"> ' . $separator . ' </li>';
           
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            $prefix="";
            echo '<li class="breadcrumb-item item-current item-archive"><strong class="bread-current bread-archive">' . post_type_archive_title($prefix, false) . '</li>';
            ...
            if($post_type != 'post') {
                ...
                echo '<li class="breadcrumb-item item-cat item-custom-post-type-' . $post_type . '"><a class="font-m bread-custom-post-type-' . $post_type . '" href="' . $post_type_archive . '" title="' . $post_type_object->labels->name . '">' . $post_type_object->labels->name . '</a></li>';
                //echo '<li class="separator"> ' . $separator . ' </li>';
            ...
            // Category page
            echo '<li class="breadcrumb-item item-current item-cat"><span ass="bread-current bread-cat">' . single_cat_title('', false) . '</span></li>';
