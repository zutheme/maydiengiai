...
function load_scripts_custom() {
    ...
    wp_enqueue_style( 'custom-woo.css', get_template_directory_uri() . '/css/custom-woo.css',array(), '0.8.5.0', false);
 //    wp_enqueue_script('library-custom.js', get_template_directory_uri() . '/js/library-custom.js', array(), '0.0.6.5', true );
	...
	// Static homepage
    	wp_enqueue_script('custom-htz_home.js', get_template_directory_uri() . '/js/custom-htz_home.js', array(), '0.1.1', true );
    }else{
