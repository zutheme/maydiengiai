...
<head>
  ...
  <?php $icon = get_field('favicon','customizer'); ?>
  <link rel="icon" type="image/png" href="<?php echo $icon['url']?>">
  <!-- fonts -->
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/css/style.css?v=0.0.0.9">
  <!-- font - fontawesome -->
...
<div class="site">
  ...
  get_template_part('layouts/menu-mobile');
  get_template_part('layouts/menu-desktop');
