...
/*---------------------------First highlight color-------------------*/
	...
	if($food_grocery_store_button_padding_top_bottom != false || $food_grocery_store_button_padding_left_right != false){
		$food_grocery_store_custom_css .='.post-main-box .more-btn a{';
			$food_grocery_store_custom_css .='padding-top: '.esc_attr($food_grocery_store_button_padding_top_bottom).'; padding-bottom: '.esc_attr($food_grocery_store_button_padding_top_bottom).';padding-left: '.esc_attr($food_grocery_store_button_padding_left_right).';padding-right: '.esc_attr($food_grocery_store_button_padding_left_right).';';
		$food_grocery_store_custom_css .='}';
	}
	...
	if($food_grocery_store_copyright_alingment != false){
		$food_grocery_store_custom_css .='.copyright p{';
			$food_grocery_store_custom_css .='text-align: '.esc_attr($food_grocery_store_copyright_alingment).';';
		$food_grocery_store_custom_css .='}';
	}