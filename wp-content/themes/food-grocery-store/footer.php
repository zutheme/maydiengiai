    ...
    <footer role="contentinfo">
        ...
        <div id="footer-2" class="pt-3 pb-3">
          	<div class="copyright container">
                ...
                <?php if( get_theme_mod( 'food_grocery_store_footer_scroll') != '') { ?>
                    ...
                    if($food_grocery_store_theme_lay == 'Left'){ ?>
                        <a href="#" class="scrollup left"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'food-grocery-store' ); ?></span></a>
                    <?php }else if($food_grocery_store_theme_lay == 'Center'){ ?>
                        <a href="#" class="scrollup center"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'food-grocery-store' ); ?></span></a>
                    <?php }else{ ?>
                        <a href="#" class="scrollup"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'food-grocery-store' ); ?></span></a>
                    <?php }?>
                <?php }?>
          	</div>
          	<div class="clear"></div>
