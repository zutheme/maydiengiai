...
/** Tên database MySQL */
define( 'DB_NAME', 'diengiai_db' );
/** Username của database */
define( 'DB_USER', 'diengiai_db' );
/** Mật khẩu của database */
define( 'DB_PASSWORD', 'cp9IALMeE' );
/** Hostname của database */
define( 'DB_HOST', 'localhost' );
//define( 'DB_HOST', '45.117.170.42' );
...
define('FTP_USER', 'diengiai');
define('FTP_PASS', 'Ulb7T6Mf');
define('FTP_HOST', '45.117.170.42');
